...
const users_store_1 = require("./stores/users.store");
const store_1 = require("@nyaf/store");
let AdminUsersComponent = class AdminUsersComponent extends lib_1.BaseComponent {
    render() {
...
AdminUsersComponent = __decorate([
    lib_1.CustomElement('admin-users'),
    store_1.ProvideStore(users_store_1.default)
], AdminUsersComponent);
